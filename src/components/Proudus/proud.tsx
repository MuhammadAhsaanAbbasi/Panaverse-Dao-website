            ...
            <Wrapper>
                <div className="py-16">
                    ...
                    <div className="grid grid-cols-12 gap-8 mt-4">
                        {
                            Data.map((item, i) => (
                                <motion.div key={i} className={`col-span-12 sm:col-span-6 lg:col-span-3 flex flex-col justify-center text-white items-center py-5 mx-4 md:mx-0 md:p-10 rounded-xl ${item.color}`}
